...
interact('.dropzone').dropzone({
  ...
  ondragleave: function (event) {
    console.log(event);
    console.log(event.relatedTarget.style.transform);
  ...
  ondrop: function (event) {
    // setTranslate(0,0,event.relatedTarget);
    console.log(event.relatedTarget.style.transform);
    if(drops[event.target.id]  == undefined){
      drops[event.target.id] = [];
    }
    drops[event.target.id][event.relatedTarget.id] = 1;
    console.log(drops);
    console.log(event);
